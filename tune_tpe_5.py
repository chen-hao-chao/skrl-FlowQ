...
def main():
    ...
    search_space = {
        ...
        "tau": tune.grid_search([0.005, 0.01, 0.05, 0.025]),
        "alpha": tune.grid_search([0.2, 0.1]),
        ...
        "path": tune.grid_search(["/mnt/nfs/skrl-FlowQ/runs/results_sac_frankacabinet_baseline/"]),
    }
