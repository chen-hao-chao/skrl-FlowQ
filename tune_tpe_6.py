...
def main():
    ...
    search_space = {
        ...
        "path": tune.grid_search(["/mnt/nfs/skrl-FlowQ/runs/results_ebflow_ingenuity/"]), #/workspace/skrl-FlowQ/runs/results_ebflow_humanoid/   OR   /mnt/nfs/skrl-FlowQ/runs/results_ebflow_humanoid/
    }
