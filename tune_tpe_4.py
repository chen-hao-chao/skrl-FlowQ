...
def main():
    ...
    search_space = {
        ...
        "tau": tune.grid_search([0.05, 0.025, 0.01, 0.005]),
        ...
        "path": tune.grid_search(["/mnt/nfs/skrl-FlowQ/runs/results_ebflow_franka/"]), #/workspace/skrl-FlowQ/runs/results_ebflow_humanoid/   OR   /mnt/nfs/skrl-FlowQ/runs/results_ebflow_humanoid/
    }
