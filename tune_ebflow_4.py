...
def main(): # conti
    ...
    search_space = {
        ...
        "path": tune.grid_search(["/mnt/nfs/lance/skrl-FlowQ/runs/results_franka/ebflow/"]), #/workspace/skrl-FlowQ/runs/results_ebflow_humanoid/   OR   /mnt/nfs/skrl-FlowQ/runs/results_ebflow_humanoid/
    }
