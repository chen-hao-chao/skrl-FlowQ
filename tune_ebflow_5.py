...
def main(): # conti
    ...
    search_space = {
        ...
        "path": tune.grid_search(["/mnt/nfs/dir/skrl-FlowQ/runs/results_humanoid/meow/"]), #/workspace/skrl-FlowQ/runs/results_ebflow_humanoid/   OR   /mnt/nfs/skrl-FlowQ/runs/results_ebflow_humanoid/
    }
